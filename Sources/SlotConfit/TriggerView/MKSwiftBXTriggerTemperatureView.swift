...
public class MKSwiftBXTriggerTemperatureView: UIView {
    ...
    private lazy var msgLabel: UILabel = {
        ...
        label.attributedText = MKSwiftUIAdaptor.createAttributedString(strings: ["Temperature threshold","   (-20℃~60℃)"], fonts: [Font.MKFont(13.0),Font.MKFont(11.0)], colors: [Color.defaultText,Color.rgb(223, 223, 223)])
